...
import MainLogoFooter from "../../public/Assets/Logos/MainLogoFooter.png";
import FooterBgImg from "../../public/Assets/Footer/FooterBgImg.jpeg";
import FooterMonkImg from "../../public/Assets/Footer/FooterMonkImg.webp";
    ...
    <footer className="footer-section">
      <div className="footer-top">
        <div className="footer-top-left">
          ...
          <span>
            ...
            and businesses through sustainable solutions and growth strategies!
          </span>
        ...
        <div className="footer-top-mid">
          <div className="footer-mid-services">
            ...
            <ul>
              <li>
                <Link href={internalLinks.services.webDev}>Web Development</Link>
              </li>
              <li>
                <Link href={internalLinks.services.branding}>Branding</Link>
              </li>
              <li>
          ...
          <div className="footer-mid-services">
            ...
            <ul>
              <li>
                <Link href={internalLinks.home}>Home</Link>
              </li>
              <li>
                <Link href={internalLinks.portfolio}>Portfolio</Link>
              </li>
              <li>
                <Link href={internalLinks.aboutUs}>About Us</Link>
              </li>
              <li>
                <Link href={internalLinks.contact}>Contact</Link>
              </li>
            </ul>
          </div>
        </div>
        <div className="footer-top-right">
          ...
          <Image width={0} height={0} src={FooterMonkImg} alt="Monk" />
        </div>
      </div>
      <div className="footer-main-mid">
        ...
        <div className="footer-top-left-contact">
          ...
          <span>
            ...
            <a href={`mailto:${companyData.companyEmail2}`}>
              {companyData.companyEmail2}
            </a>
          </span>
          <span>
            <svg
            ...
            <a href={`tel:${companyData.companyPhone2}`}>
              {companyData.companyPhone2}
            </a>
          </span>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-links">
          ...
          <Link href={internalLinks.privacyPolicy}>PRIVACY POLICY</Link>
          <Link href={internalLinks.terms}>TERMS AND CONDITIONS</Link>
